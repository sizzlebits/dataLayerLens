// Mock browser extension API for Storybook
...
// Apply mock globally before any code runs
if (typeof window !== 'undefined') {
  (window as unknown as { chrome: typeof mockBrowserAPI }).chrome = mockBrowserAPI;
  (window as unknown as { browser: typeof mockBrowserAPI }).browser = mockBrowserAPI;
}

// Also define as global for SSR/node environments
if (typeof globalThis !== 'undefined') {
  (globalThis as unknown as { chrome: typeof mockBrowserAPI }).chrome = mockBrowserAPI;
  (globalThis as unknown as { browser: typeof mockBrowserAPI }).browser = mockBrowserAPI;
}
